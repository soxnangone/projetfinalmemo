            ...
            <section class="content invoice">
              ...
              <div class="row">
                ...
                <div class="col-xs-6">
                  ...
                  <img src="{{ asset('assets/gentelella/images/visa.png') }}" alt="Visa">
                  <img src="{{ asset('assets/gentelella/images/mastercard.png') }}" alt="Mastercard">
                  <img src="{{ asset('assets/gentelella/images/american-express.png') }}" alt="American Express">
                  <img src="{{ asset('assets/gentelella/images/paypal.png') }}" alt="Paypal">
