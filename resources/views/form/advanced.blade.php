...
<link href="{{ url('assets/gentelella/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css') }}" rel="stylesheet">
<!-- Ion.RangeSlider -->
<link href="{{ url('assets/gentelella/vendors/normalize-css/normalize.css') }}" rel="stylesheet">
<link href="{{ url('assets/gentelella/vendors/ion.rangeSlider/css/ion.rangeSlider.css') }}" rel="stylesheet">
<link href="{{ url('assets/gentelella/vendors/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css') }}" rel="stylesheet">
<!-- Bootstrap Colorpicker -->
<link href="{{ url('assets/gentelella/vendors/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}" rel="stylesheet">

<link href="{{ url('assets/gentelella/vendors/cropper/dist/cropper.min.css') }}" rel="stylesheet">
@endsection
...
<!-- bootstrap-datetimepicker -->    
<script src="{{ url('assets/gentelella/vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js') }}"></script>
<!-- Ion.RangeSlider -->
<script src="{{ url('assets/gentelella/vendors/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
<!-- Bootstrap Colorpicker -->
<script src="{{ url('assets/gentelella/vendors/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
<!-- jquery.inputmask -->
<script src="{{ url('assets/gentelella/vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js') }}"></script>
<!-- jQuery Knob -->
<script src="{{ url('assets/gentelella/vendors/jquery-knob/dist/jquery.knob.min.js') }}"></script>
<!-- Cropper -->
<script src="{{ url('assets/gentelella/vendors/cropper/dist/cropper.min.js') }}"></script>
          ...
          <div class="row">
            <div class="col-md-9">
              <div class="img-container">
                <img id="image" src="{{ url('assets/gentelella/images/cropper.jpg') }}" alt="Picture">
              </div>
            </div>
            <div class="col-md-3">
