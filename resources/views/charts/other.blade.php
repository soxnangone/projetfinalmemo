...
<script src="{{ url('assets/gentelella/vendors/jqvmap/dist/maps/jquery.vmap.usa.js') }}"></script>
<script src="{{ url('assets/gentelella/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js') }}"></script>
<!-- easy-pie-chart -->
<script src="{{ url('assets/gentelella/vendors/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js') }}"></script>
@endsection
